"""Bounded publication wrapper for Brahms's 3 Quartets, Op.64.
...
BATCH = PublicationBatch(
    ids=IDS,
    batch_id='brahms-three-quartets-op64-one-20260905',
    stage_rel=Path('imports/johannes_brahms/staging/three-quartets-op64'),
    work_titles=('3 Quartets, Op.64',),
    log_message='新增勃拉姆斯《3 Quartets, Op. 64》完整乐谱 1 份：三首德语四重唱与钢琴作品，附各曲实际 PDF 起始页。',
