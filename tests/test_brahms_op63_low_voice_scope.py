...
from tools.brahms_op63_low_voice_batch import BATCH, IDS


class BrahmsOp63LowVoiceScopeTests(unittest.TestCase):
    def test_batch_is_bounded_to_nine_expected_files(self):
        self.assertEqual(len(IDS), 9)
        self.assertEqual(BATCH.ids, IDS)
        self.assertEqual(BATCH.work_titles, ('9 Lieder and Songs, Op.63',))
