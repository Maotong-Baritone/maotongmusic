...
from tools.brahms_op69_low_voice_batch import BATCH, IDS


class BrahmsOp69LowVoiceScopeTests(unittest.TestCase):
    def test_batch_is_bounded_to_nine_expected_files(self):
        self.assertEqual(len(IDS), 9)
        self.assertEqual(BATCH.ids, IDS)
        self.assertEqual(BATCH.work_titles, ('9 Songs, Op.69',))
