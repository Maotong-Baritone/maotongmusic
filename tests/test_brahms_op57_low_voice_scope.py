...
from tools.brahms_op57_low_voice_batch import BATCH, IDS


class BrahmsOp57LowVoiceScopeTests(unittest.TestCase):
    def test_batch_is_bounded_to_eight_expected_files(self):
        self.assertEqual(len(IDS), 8)
        self.assertEqual(BATCH.ids, IDS)
        self.assertEqual(BATCH.work_titles, ('8 Lieder and Songs, Op.57',))
